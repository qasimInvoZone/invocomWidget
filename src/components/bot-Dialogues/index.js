        ...
        const registerUser = async () => {
            ...
            return(
                ...
                <div className="form-wrapper">
                    ...
                    {isExist? <div style={{color: "red", fontSize: "12px", fontWeight:"bold"}}>User Already Exists</div> : ''}
                    {email == '' && showError? <div style={{color: "red", fontSize: "12px", fontWeight:"bold"}}> * Cannot set Empty Email </div> : "" }
                    ...
                    <button className="bg-blue-500 rounded mt-2 text-sm text-white" onClick={() => registerUser()}>Send</button>
                </div>
                </>
            );
